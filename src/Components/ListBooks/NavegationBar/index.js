            ...
            <nav className="default-primary-color">
                <div className="nav-wrapper">
                    ...
                    <ul className="right hide-on-med-and-down">
                        <li><a href="#filter" className="waves-effect"><i className="waves-effect fa fa-filter icon-menu"/>Filter</a></li>
                        <li><a href="#import" className="waves-effect"><i className="fa fa-cloud-download icon-menu"/>Import</a></li>
                        <li><a href="#signin" className="waves-effect"><i className="fa fa-sign-in icon-menu"/>Sign In</a></li>
                    </ul>
                    <SidePanel />
                </div>
            </nav>
