        ...
        return (
            <ul className="sidenav front-element" id="slide-out">
                <li><div className="user-view">
                        ...
                        <a href="#!user"><img className="circle" src="http://lorempixel.com/300/300/people/" alt="" /></a>
                ...
                <li><a href="#signin" className="waves-effect modal-trigger" data-target="modal1"><i className="fa fa-sign-in icon-menu icon-menu"/>Sign In</a></li>
            </ul>
        )
    }
}
